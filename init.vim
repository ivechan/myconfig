...
nnoremap <silent><nowait> <space>a  :NewGrep<SPACE>
nnoremap <silent><nowait> <space>g  :NewGrep <c-r><c-w><CR>
" Manage extensions
nnoremap <silent><nowait> <space>f  :<C-u>CocList files<cr>
nnoremap <silent><nowait> <space>l  :<C-u>CocList lines<cr>
" Show commands
nnoremap <silent><nowait> <M-m>  :<C-u>CocList mru<cr>
...
nnoremap <silent><nowait> <space>q  :copen<CR>
nnoremap <silent><nowait> <c-n>  :cnext<CR>
nnoremap <silent><nowait> <c-p>  :cprev<CR>
